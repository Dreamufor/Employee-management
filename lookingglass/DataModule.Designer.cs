...
namespace LookingGlass
{
    ...
    "cyID";
            ...
            // ctnLookingGlass
            // 
            this.ctnLookingGlass.ConnectionString = "Provider=Microsoft.Jet.OLEDB.4.0;Data Source=C:\\Temp\\LookingGlass.mdb";
            // 
            // oleDbInsertCommand1
            // 
    ...
    " ?) AND (`CandidateID` = ?))";
            ...
            this.daApplication.RowUpdated += new System.Data.OleDb.OleDbRowUpdatedEventHandler(this.oleDbDataAdapter1_RowUpdated_1);
            // 
            // oleDbSelectCommand2
            // 
    ...
    ") VALUES (?, ?, ?, ?)";
            ...
            this.daEmployer.RowUpdated += new System.Data.OleDb.OleDbRowUpdatedEventHandler(this.daEmployer_RowUpdated);
            this.daEmployer.FillError += new System.Data.FillErrorEventHandler(this.daEmployer_FillError);
            // 
            // oleDbSelectCommand5
            // 
    ...
    " VACANCY\r\nORDER BY VacancyID";
            ...
            // daVacancy
            // 
            this.daVacancy.DeleteCommand = this.oleDbDeleteCommand;
            this.daVacancy.InsertCommand = this.oleDbInsertCommand;
            ...
            new System.Data.Common.DataTableMapping("Table", "VACANCY", new System.Data.Common.DataColumnMapping[] {
                        ...
                        new System.Data.Common.DataColumnMapping("EmployerID", "EmployerID")})});
            this.daVacancy.UpdateCommand = this.oleDbUpdateCommand;
            // 
            // oleDbSelectCommand7
            // 
    ...
    "acancyID";
            ...
            this.oleDbInsertCommand7.Connection = this.ctnLookingGlass;
    ...
    " ?)))";
            this.oleDbUpdateCommand7.Connection = this.ctnLookingGlass;
    ...
    " 1 AND `Years` IS NULL) OR (`Years` = ?)))";
            this.oleDbDeleteCommand7.Connection = this.ctnLookingGlass;
            ...
            // oleDbInsertCommand
            // 
            this.oleDbInsertCommand.CommandText = "INSERT INTO `VACANCY` (`Description`, `Status`, `Salary`, `EmployerID`) VALUES (?" +
    ", ?, ?, ?)";
        ...
        private OleDbDataAdapter daCandidate;
        ...
        private OleDbDataAdapter daCandidateSkill;
        ...
        private OleDbDataAdapter daEmployer;
        ...
        private OleDbDataAdapter daSkill;
        private OleDbCommand oleDbSelectCommand6;
        private OleDbDataAdapter daVacancy;
        ...
        private OleDbDataAdapter daVacancySkill;
        public DSLookingGlass dsLookingGlass;
